...
$stmt2 = $conn->prepare("SELECT juego1 FROM puntajes WHERE user_id=?");
$stmt2->bind_param("i", $user_id);
$stmt2->execute();
$res2 = $stmt2->get_result();
$scoreData = $res2->fetch_assoc();
$currentScore = $scoreData ? $scoreData['juego1'] : 0;
$allPairs =  [
    ["House", "Casa"], ["Car", "Carro"], ["Book", "Libro"], ["Milk", "Leche"],
    ["Table", "Mesa"], ["Chair", "Silla"], ["Sun", "Sol"], ["Moon", "Luna"]
];
...
<div id="restart-container" style="display:none;margin-top:20px;">
    <a href="curso_1ro.php" style="padding:12px 25px;background:#FFB300;color:#4b2f00;border-radius:12px;font-weight:bold;text-decoration:none;">Volver a los cursos</a>
</div>
...
fetch("guardar_memorama_1ro.php", { 
    method: "POST",
