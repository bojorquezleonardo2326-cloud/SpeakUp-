...
$messages = [
    ...
    "¡Vamos a descubrir cosas nuevas, $first_name!",
    "¿Preparad@ para el próximo juego, $first_name?"
];
...
<div class="navbar">
    ...
    <button onclick="window.location.href='cursos_2do.php'">Volver a los cursos</button>
</div>
...
<div class="courses-grid">
    <div class="course-card" onclick="window.location.href='memorama2.php'">Memorama</div>
    <div class="course-card" onclick="window.location.href='trivia2.php'">Trivia</div>
    <div class="course-card" onclick="window.location.href='colores2.php'">Colores</div>
    <div class="course-card" onclick="window.location.href='vocales2.php'">Vocales</div>
    <div class="course-card" onclick="window.location.href='numeros2.php'">Números</div>
    <div class="course-card" onclick="window.location.href='animales2.php'">Animales</div>
</div>
