...
$questions = [
    ['sentence' => 'Good (☀️)', 'answer' => 'morning'],
    ['sentence' => 'Good (🌙)', 'answer' => 'night'],
    ['sentence' => 'Thank (🫵)', 'answer' => 'you'],
    ['sentence' => 'I (❤️) you', 'answer' => 'love'],
    ['sentence' => 'Happy (🎂)', 'answer' => 'birthday'],
    ['sentence' => 'A (🐶) says woof!', 'answer' => 'dog'],
    ['sentence' => 'A (🐱) says meow!', 'answer' => 'cat'],
    ['sentence' => 'A (🚗) goes vroom!', 'answer' => 'car'],
    ['sentence' => 'A (☀️) a day', 'answer' => 'sunny'],
    ['sentence' => 'Have a (😄) day!', 'answer' => 'nice']
];
shuffle($questions);
...
<div id="start-overlay">
    ...
    <a href="cursos_1ro.php" style="margin-top:18px;background:#FFB300;padding:10px 20px;border-radius:12px;font-weight:700;color:#4b2f00;text-decoration:none;display:inline-block;box-shadow:0 4px 0 #d89a00;transition:0.2s;">⬅ Regresar al inicio</a>
</div>
...
<div id="restart-container" style="display:none;"><a href="cursos_1ro.php">Volver a cursos</a></div>
...
document.getElementById('start-btn').onclick=()=>{
    ...
    const interval=setInterval(()=>{
        ...
        count--; cd.textContent=count>0?count:"GO!!";
        if(count<0){
