...
<div class="courses-grid">
    <div class="course-card" onclick="window.location.href='Writing1.php'">
        Writing
        <span>Escritura</span>
    </div>
    <div class="course-card" onclick="window.location.href='Listening1.php'">
        Listening
        <span>Escucha</span>
    </div>
    <div class="course-card" onclick="window.location.href='Grammar1.php'">
        Grammar
        <span>Gramática</span>
    </div>
    <div class="course-card" onclick="window.location.href='juegos1.php'">
        Games
        <span>Juegos</span>
    </div>
</div>
